...
const signin = async ({ id, password }, secret, res) => {
  ...
  if (token) {
    ...
    const serialized = cookie.serialize('token', token, {
      ...
      /* Used this config for third-party cookies, but that didn't work in safari, so had to use a rewrite rule in the _redirects file of the build folder on the frontsite. */
