...
;
DELETE FROM ShippedOrderSources
;
...
INSERT Maps (Id, IsoCountryCode, ErpCompanyId, IsoCurrencyCode, ErpCurrencyCode, SourceWarehouse, SourceShipMethod, DestinationWarehouse, ReturnsWarehouse, IsVAT, UseForErpPull, ProcessingSequence, ActivatedAt, DeactivatedAt, CreatedAt, CreatedBy, ModifiedAt, ModifiedBy) VALUES (1, N'US', N'CompanyId1', N'USD', N'USD', N'1', NULL, N'DC-USASLC', N'DC-USARTRN', 0, 1, 1, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0330000' AS datetime), 1, CAST(N'2023-06-27T19:02:24.4470000' AS datetime), 1)
;
INSERT Maps (Id, IsoCountryCode, ErpCompanyId, IsoCurrencyCode, ErpCurrencyCode, SourceWarehouse, SourceShipMethod, DestinationWarehouse, ReturnsWarehouse, IsVAT, UseForErpPull, ProcessingSequence, ActivatedAt, DeactivatedAt, CreatedAt, CreatedBy) VALUES (2, N'CA', N'CompanyId2', N'CAD', N'CAD', N'2', NULL, N'DC-CA', N'DC-CARTRN', 0, 1, 2, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0400000' AS datetime), 1)
;
INSERT Maps (Id, IsoCountryCode, ErpCompanyId, IsoCurrencyCode, ErpCurrencyCode, SourceWarehouse, SourceShipMethod, DestinationWarehouse, ReturnsWarehouse, IsVAT, UseForErpPull, ProcessingSequence, ActivatedAt, DeactivatedAt, CreatedAt, CreatedBy) VALUES (3, N'AU', N'CompanyId13', N'USD', N'USD', N'4', NULL, N'DC-USASLC', N'DC-USARTRN', 0, NULL, 4, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0400000' AS datetime), 1)
;
INSERT Maps (Id, IsoCountryCode, ErpCompanyId, IsoCurrencyCode, ErpCurrencyCode, SourceWarehouse, SourceShipMethod, DestinationWarehouse, ReturnsWarehouse, IsVAT, UseForErpPull, ProcessingSequence, ActivatedAt, DeactivatedAt, CreatedAt, CreatedBy) VALUES (4, N'PH', N'CompanyId4', N'PHP', N'PHP', N'5', NULL, N'DC-PHL', N'DC-PHLRTRN', 1, 1, 3, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0700000' AS datetime), 1)
;
INSERT Maps (Id, IsoCountryCode, ErpCompanyId, IsoCurrencyCode, ErpCurrencyCode, SourceWarehouse, SourceShipMethod, DestinationWarehouse, ReturnsWarehouse, IsVAT, UseForErpPull, ProcessingSequence, ActivatedAt, DeactivatedAt, CreatedAt, CreatedBy) VALUES (5, N'PH', N'CompanyId5', N'PHP', N'PHP', N'5', N'Philippines Office Pickup', N'DC-PHLWC', N'DC-PHLRTRN', 1, NULL, 3, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0730000' AS datetime), 1)
;
INSERT Maps (Id, IsoCountryCode, ErpCompanyId, IsoCurrencyCode, ErpCurrencyCode, SourceWarehouse, SourceShipMethod, DestinationWarehouse, ReturnsWarehouse, IsVAT, UseForErpPull, ProcessingSequence, ActivatedAt, DeactivatedAt, CreatedAt, CreatedBy) VALUES (6, N'US', N'CompanyId6', N'USD', N'USD', N'6', NULL, N'DC-EVENTS', N'DC-USARTRN', 0, NULL, 1, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0800000' AS datetime), 1)
;
