...
insert into DashboardPages (Actions, Id, Page) values (NULL, 4, 'Settings');
insert into DashboardPages (Actions, Id, Page) values ('Add, Delete', 5, 'Users');
insert into DashboardPages (Actions, Id, Page) values ('Register, Sign In, Sign Out', 6, 'Sign Up, Sign In, Sign Out');
