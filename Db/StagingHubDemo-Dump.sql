...
--
-- Host: localhost    Database: StagingHubDemo
-- ------------------------------------------------------
...
CREATE TABLE `Addresses` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=67474 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
/*!40000 ALTER TABLE `AppParams` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `AppParams` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `AppParamValueTypes` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `AppParamValueTypes` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `CanadaFileTracking` DISABLE KEYS */;
/*!40000 ALTER TABLE `CanadaFileTracking` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `DashboardPages` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `DashboardPages` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ErpReturnOrderLines` DISABLE KEYS */;
/*!40000 ALTER TABLE `ErpReturnOrderLines` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ErpReturnOrders` DISABLE KEYS */;
/*!40000 ALTER TABLE `ErpReturnOrders` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ErpShipmentTracking` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ErpShipmentTracking` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `IgnorePush` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `IgnorePush` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `OrderBatch` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `OrderBatch` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=18387 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `OrderBatchDetail` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `OrderBatchDetail` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=75604 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=32664 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `OrderStagingErrors` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `OrderStagingErrors` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=26215 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `PaymentsTracking` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `PaymentsTracking` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ProcessedTransactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `ProcessedTransactions` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ProcessingErrors` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ProcessingErrors` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ProcessJobs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ProcessJobs` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `PurgeRunDetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `PurgeRunDetails` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `PurgeRuns` DISABLE KEYS */;
/*!40000 ALTER TABLE `PurgeRuns` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `PushStatuses` DISABLE KEYS */;
INSERT INTO `PushStatuses` VALUES (1,'Sent'),(2,'Failed'),(3,'Ignored'),(4,'Placeholder');
/*!40000 ALTER TABLE `PushStatuses` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ShippedOrderlines` DISABLE KEYS */;
/*!40000 ALTER TABLE `ShippedOrderlines` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ShippedOrderSources` DISABLE KEYS */;
INSERT INTO `ShippedOrderSources` VALUES (1,'CRM-company'),(2,'company-ERP'),(3,'3PL-CAN'),(4,'3PL-PHL');
/*!40000 ALTER TABLE `ShippedOrderSources` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-08-07 13:05:55
