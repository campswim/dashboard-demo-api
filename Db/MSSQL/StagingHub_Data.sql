...
INSERT [dbo].[AppParamValueTypes] ([Id], [Type]) VALUES (13, N'XML')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'AfilliateWarehouseMap', N'SC-SHIPOFR=SHIPOFFERS', N'100', N'Order', N'Mapping', 10, N'Mapping exigo shipped orders for affiliates', CAST(N'2023-06-01T00:00:00.0000000' AS datetime), CAST(N'2023-03-27T21:49:39.8400000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'BcClientId', N'13c767fd-b54b-4470-9ee9-acdcd9c8a0b1', N'200,201,210,211,212', N'BCAPI', N'API', 10, N'D365 Business Central ClientId', CAST(N'2022-05-13T00:00:00.0000000' AS datetime), CAST(N'2023-01-02T22:23:30.2200000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'BcClientSecret', N'nN17Q~HJn3ABQhcfnKQG7UNymH3-HRQl9-PVt', N'200,201,210,211,212', N'BCAPI', N'API', 10, N'D365 Business Central Client Secret', CAST(N'2022-05-13T00:00:00.0000000' AS datetime), CAST(N'2023-01-02T22:23:30.2200000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'BcEnvironment', N'SandBx_YOLI_UAT_05122023', N'200,201,210,211,212', N'BCAPI', N'API', 10, N'D365 Business Central environment name', CAST(N'2022-05-13T00:00:00.0000000' AS datetime), CAST(N'2023-01-02T22:23:30.2200000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'BcMarketShipAgent', N'US=,PH=WILL CALL', N'210', N'Shipping Info', N'Mapping', 10, N'Mapping shipping agents by market', CAST(N'2022-03-27T00:00:00.0000000' AS datetime), CAST(N'2023-03-27T21:39:10.2200000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'BcPmtJournalBatchName', N'EXIGO', N'211', N'Payment', N'Cash Receipt', 10, N'For  ', CAST(N'2023-01-03T00:00:00.0000000' AS datetime), CAST(N'2023-01-03T22:19:20.0600000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'CAN3PLFolders', N'Incoming=Warehouse\Tracking\CAN;Processed=Warehouse\Tracking\CAN\Completed;Failed=Warehouse\Tracking\CAN\Failed;Outgoing=ExigoFTP\CAN', N'310,311', N'3PL', N'File', 10, N'file folder....', CAST(N'2023-04-04T00:00:00.0000000' AS datetime), CAST(N'2023-04-04T17:20:45.8900000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'CAN3PLIncomingFolder', N'CAN Samples/ToProcess', N'310', N'Ship', N'3PL CAN', 10, N'Incoming folder for CAN 3PL response file processing', CAST(N'2023-03-07T00:00:00.0000000' AS datetime), CAST(N'2023-03-07T14:56:27.9500000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'CAN3PLShippingCodes', N'{"Canada Post Standard": "10", "Canada Post Express": "11"}', N'310', N'3PL', N'Shipping codes', 12, N'Outgoing 3PL shipping codes', CAST(N'2023-08-28T00:00:00.0000000' AS datetime), CAST(N'2023-08-28T00:00:00.00000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'CAN3PLParseFileExt', N'*.txt', N'311', N'3PL', N'File extension', 10, N'Single File extension for CAN 3PL incoming shipping files to process', CAST(N'2023-08-28T00:00:00.0000000' AS datetime), CAST(N'2023-08-28T00:00:00.00000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'ErpCmGlAccountNumbers', N'TAX=2400;SHIPPING=4400;other=4500', N'210', N'Order', N'CreditMemo', 10, N'Gl Account nbrs to use for CM categories', CAST(N'2023-05-10T00:00:00.0000000' AS datetime), CAST(N'2023-05-10T20:34:50.1900000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'ExigoPromoAltSKUs', N'Yoli+ Free Shipping Discount=SHIPPING', N'210', N'Order', N'Line', 10, N'dict key is Promo description and value is ALT SKU to use in ERP', CAST(N'2022-08-09T00:00:00.0000000' AS datetime), CAST(N'2023-01-02T22:23:30.2200000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'ExigoPromoSKU', N'Promo', N'210', N'Order', N'Line', 10, N'Single Exigo promotional SKU', CAST(N'2022-08-09T00:00:00.0000000' AS datetime), CAST(N'2023-01-02T22:23:30.2200000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'FileShareRoot', N'/Users/Chadlarson/Downloads/', N'310,311,320,321', N'Ship', N'3PL Proc', 10, N'FileShare root folder for 3PL response file processing', CAST(N'2023-03-07T00:00:00.0000000' AS datetime), CAST(N'2023-03-07T14:56:27.9500000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'ImportIgnoreOrderTypes', N'8', N'100', N'Order', N'Select', 10, N'Comma separated list of ordertypes to ignore', CAST(N'2021-11-10T00:00:00.0000000' AS datetime), CAST(N'2021-11-10T00:00:00.0000000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OnlyImportOrdersOverAmount', N'0.00', N'100', N'Order', N'Select', 5, N'Minimum amount of order to consider importing', NULL, CAST(N'2020-06-10T20:14:49.6800000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OrderPullBatchsize', N'500', N'100,101', N'Order', N'Select', 2, NULL, CAST(N'2021-01-01T00:00:00.0000000' AS datetime), CAST(N'2020-06-10T20:14:49.6800000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OrderPullDaysBack', N'4', N'100,101', N'Order', N'Select', 2, NULL, NULL, CAST(N'2020-09-22T00:00:00.0000000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OrderPullLastDate', N'', N'100', N'Order', N'Select', 8, N'Last date of order pull from source system', CAST(N'2021-10-18T00:00:00.0000000' AS datetime), CAST(N'2020-06-10T20:14:49.6800000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OrderPullMinOrderNumber', N'51800000', N'100,101,102', N'Order', N'Select', 2, N'Only pull order#s > than this value. Use 0 to turn this off', CAST(N'2021-10-15T00:00:00.0000000' AS datetime), CAST(N'2021-10-26T00:00:00.0000000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OrderPushBatchSize', N'200', N'210', N'Order', N'Select', 2, NULL, CAST(N'2021-10-15T00:00:00.0000000' AS datetime), CAST(N'2020-06-10T20:14:49.6800000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OverrideOrderShipmethodWithDefault', N'false', N'210', N'Order', N'Header', 1, NULL, CAST(N'2021-01-01T00:00:00.0000000' AS datetime), CAST(N'2020-06-10T20:14:49.6800000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'PHL3PLFolders', N'Incoming=Warehouse\Tracking\PHI;Processed=Warehouse\Tracking\PHI\Completed;Failed=Warehouse\Tracking\PHI\Failed;Outgoing=ExigoFTP\PHI', N'320,321', N'3PL', N'File', 10, N'file folder....', CAST(N'2023-04-04T00:00:00.0000000' AS datetime), CAST(N'2023-04-04T17:23:02.1900000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'PushCountriesForTaxId', N'PH', N'100', N'Customer', N'Tax', 10, N'County list for pulling customer TaxId', CAST(N'2023-01-02T22:23:30.0000000' AS datetime), CAST(N'2023-01-02T22:23:30.2200000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'UseLastPaymentDateForOrder', N'true', NULL, N'Order', N'Header', 1, N'Use Last payment date for the order date. Good for partial paid orders or stale orders that sat in shopping cart', CAST(N'2021-09-01T00:00:00.0000000' AS datetime), CAST(N'2021-09-01T00:00:00.0000000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'OrderPullPickupShipMethodIds', N'8,18,23', N'100', N'Order', N'Selection', 10, N'Limit to these Exigo pickup ship methods', CAST(N'2023-08-28T00:00:00.0000000' AS datetime), CAST(N'2023-08-28T21:49:39.8400000' AS datetime), N'Chadl')
GO
INSERT [dbo].[AppParams] ([Name], [Value], [ProcessJobIds], [Category], [SubCategory], [ValueTypeId], [Notes], [EnabledDate], [CreatedAt], [CreatedBy]) VALUES (N'BcOrderSummarySku', N'PRODUCT', N'210', N'Order', N'Lines', 2, N'Put the BC SKU here if wanting to summarize all regular items into a single orderline in BC', CAST(N'2023-09-14T00:00:00.0000000' AS datetime), CAST(N'2023-09-14T00:00:00.0000000' AS datetime), N'Chadl')
GO
...
GO
INSERT [dbo].[Maps] ([Id], [IsoCountryCode], [ErpCompanyId], [IsoCurrencyCode], [ErpCurrencyCode], [SourceWarehouse], [SourceShipMethod], [DestinationWarehouse], [ReturnsWarehouse], [IsVAT], [UseForErpPull], [ProcessingSequence], [ActivatedAt], [DeactivatedAt], [CreatedAt], [CreatedBy]) VALUES (1, N'US', N'd88d601b-1c22-ec11-8f45-000d3a1bd9aa', N'USD', N'USD', N'1', NULL, N'DC-USASLC', N'DC-USARTRN', 0, 1, 1, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0330000' AS datetime), N'chadl', CAST(N'2023-06-27T19:02:24.4470000' AS datetime), N'15')
GO
INSERT [dbo].[Maps] ([Id], [IsoCountryCode], [ErpCompanyId], [IsoCurrencyCode], [ErpCurrencyCode], [SourceWarehouse], [SourceShipMethod], [DestinationWarehouse], [ReturnsWarehouse], [IsVAT], [UseForErpPull], [ProcessingSequence], [ActivatedAt], [DeactivatedAt], [CreatedAt], [CreatedBy]) VALUES (2, N'CA', N'b242ba0f-ff51-ec11-9f08-000d3a14a707', N'CAD', N'CAD', N'2', NULL, N'DC-CA', N'DC-CARTRN', 0, 1, 2, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0400000' AS datetime), N'chadl')
GO
INSERT [dbo].[Maps] ([Id], [IsoCountryCode], [ErpCompanyId], [IsoCurrencyCode], [ErpCurrencyCode], [SourceWarehouse], [SourceShipMethod], [DestinationWarehouse], [ReturnsWarehouse], [IsVAT], [UseForErpPull], [ProcessingSequence], [ActivatedAt], [DeactivatedAt], [CreatedAt], [CreatedBy]) VALUES (3, N'AU', N'd88d601b-1c22-ec11-8f45-000d3a1bd9aa', N'USD', N'USD', N'4', NULL, N'DC-USASLC', N'DC-USARTRN', 0, NULL, 4, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0400000' AS datetime), N'chadl')
GO
INSERT [dbo].[Maps] ([Id], [IsoCountryCode], [ErpCompanyId], [IsoCurrencyCode], [ErpCurrencyCode], [SourceWarehouse], [SourceShipMethod], [DestinationWarehouse], [ReturnsWarehouse], [IsVAT], [UseForErpPull], [ProcessingSequence], [ActivatedAt], [DeactivatedAt], [CreatedAt], [CreatedBy]) VALUES (4, N'PH', N'34195264-ff51-ec11-9f08-000d3a14a707', N'PHP', N'PHP', N'5', NULL, N'DC-PHL', N'DC-PHLRTRN', 1, 1, 3, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0700000' AS datetime), N'chadl')
GO
INSERT [dbo].[Maps] ([Id], [IsoCountryCode], [ErpCompanyId], [IsoCurrencyCode], [ErpCurrencyCode], [SourceWarehouse], [SourceShipMethod], [DestinationWarehouse], [ReturnsWarehouse], [IsVAT], [UseForErpPull], [ProcessingSequence], [ActivatedAt], [DeactivatedAt], [CreatedAt], [CreatedBy]) VALUES (5, N'PH', N'34195264-ff51-ec11-9f08-000d3a14a707', N'PHP', N'PHP', N'5', N'Philippines Office Pickup', N'DC-PHLWC', N'DC-PHLRTRN', 1, NULL, 3, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0730000' AS datetime), N'chadl')
GO
INSERT [dbo].[Maps] ([Id], [IsoCountryCode], [ErpCompanyId], [IsoCurrencyCode], [ErpCurrencyCode], [SourceWarehouse], [SourceShipMethod], [DestinationWarehouse], [ReturnsWarehouse], [IsVAT], [UseForErpPull], [ProcessingSequence], [ActivatedAt], [DeactivatedAt], [CreatedAt], [CreatedBy]) VALUES (6, N'US', N'd88d601b-1c22-ec11-8f45-000d3a1bd9aa', N'USD', N'USD', N'6', NULL, N'DC-EVENTS', N'DC-USARTRN', 0, NULL, 1, CAST(N'2023-01-01T00:00:00.0000000' AS datetime), NULL, CAST(N'2023-01-02T23:11:19.0800000' AS datetime), N'chadl')
GO
